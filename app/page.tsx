...
export default function Home() {
  ...
  const scrims = [
    ...
    { region: "EU", platform: "Console", team: "Sage Team", range: "2.3k", time: "6PM" },
  ];
  ...
  return (
    <main className="min-h-screen bg-gray-600 text-white flex flex-col items-center p-10">
      ...
      <Link
        href="/create"
        className="bg-orange-500 hover:bg-orange-600 px-6 py-3 rounded-lg font-semibold transition mb-8"
      >
        Create Scrim
      </Link>
